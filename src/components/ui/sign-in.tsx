  ...
  return (
    <div className="min-h-screen mt-20 w-full bg-white">
      <div className="flex items-center justify-center p-4 md:p-6 relative">
        <div
          className={`w-full max-w-2xl overflow-hidden rounded-3xl bg-white shadow-2xl transition-all duration-500 relative ${
          ...
          <div className="relative w-full h-[400px] md:h-[500px]">
            ...
            >
              ...
              <div className="w-full max-w-sm">
                <button
                  type="button"
                  className="flex w-full items-center justify-center gap-3 rounded-lg bg-white py-3 px-6 text-sm font-medium text-primary hover:bg-white/90 transition-colors shadow-lg"
                >
                  <svg
                    className="h-5 w-5"
                    viewBox="0 0 24 24"
